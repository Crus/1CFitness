...
// Устарела. Следует использовать процедуру ДобавитьПодписьКФайлу.
Процедура ЗанестиИнформациюОднойПодписи(Знач ПрисоединенныйФайл, Знач ДанныеПодписи) Экспорт
	...
	СвойстваПодписи.Вставить("Комментарий",         ДанныеПодписи.Комментарий);
	СвойстваПодписи.Вставить("ИмяФайлаПодписи",     ДанныеПодписи.ИмяФайлаПодписи);
	СвойстваПодписи.Вставить("КомуВыданСертификат", ДанныеПодписи.КомуВыданСертификат);
	СвойстваПодписи.Вставить("Сертификат",          ДанныеПодписи.ДвоичныеДанныеСертификата);
	
	ДобавитьПодписьКФайлу(ПрисоединенныйФайл, СвойстваПодписи);
	
КонецПроцедуры

// Устарела. Следует использовать процедуру ДобавитьПодписьКФайлу.
Процедура ЗанестиИнформациюОПодписях(Знач ПрисоединенныйФайл, Знач МассивПодписей) Экспорт
	...
	ДобавитьПодписьКФайлу(ПрисоединенныйФайл, СвойстваПодписей);
